...
var Highcharts_Combo_Chart;
(function (Highcharts_Combo_Chart) {
    ...
    Highcharts_Combo_Chart.draw = draw;
    ...
    function create_empty_series(x_order, by_order) {
        let output = new Map();
    ...
    function fill_values(output, chart, data, x_order) {
    ...
    function get_color_at(i, series, data, variable) {
    ...
    function get_axis_at(i, series, data, variable) {
        if (!data.has_variable(variable))
            return;
    ...
    function get_type_at(i, series, data, variable) {
        if (!data.has_variable(variable))
            return;
    ...
    function get_legend_options(chart) {
    ...
    function get_y_axis_options(chart) {
    ...
    function get_line_options(chart) {
        return {
            lineWidth: chart.get_line_width(),
            marker: get_marker_options(chart, true, true, 0)
        };
    }
    function get_marker_options(chart, enabled, enabled_on_hover, line_width) {
        return {
            enabled: enabled,
    ...
    function get_spline_options(chart) {
        return get_line_options(chart);
    }
    function get_column_options(chart) {
    ...
    function get_area_options(chart) {
        return {
            lineColor: '#000000',
            lineWidth: 1,
