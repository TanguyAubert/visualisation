...
module Highcharts_Pie_Chart
{
    type Series = {name : string, y : number, color?: string}[];

    export function draw(chart : Pie_Chart, structure : Structure)
    {
    ...
    function convert_data_to_series(chart : Pie_Chart, data : Data)
	{
    ...
    function get_color_at(i : number, series : Series, index : number, data : Data, variable : string)
    {
	...
	function get_options(chart : Pie_Chart, structure : Structure, series : Series)
	{
		return {
			title:         { text: "" },
			subtitle:      { text: "" },
    ...
    function get_chart_options(chart : Pie_Chart, structure : Structure)
    {
    ...
    function get_tooltip_options(chart : Pie_Chart)
    {
    ...
    function get_plot_options(chart : Pie_Chart)
    {
        return {
    ...
    function get_pie_options(chart : Pie_Chart)
    {
        let numeric_format = chart.get_digits() !== null ? ":." + chart.get_digits() + "f" : "";
    ...
    function get_series_options(series : Series)
    {
        return [{
            states: {},
            data: series
